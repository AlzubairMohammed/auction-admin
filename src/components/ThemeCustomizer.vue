    ...
    <div>
     ...
     <div class="border border-dashed border-[#e0e6ed] dark:border-[#1b2e4b] rounded-md mb-3 p-3">
      ...
      <div class="grid grid-cols-3 gap-2 mt-3">
       <button type="button" class="btn" :class="[store.theme === 'light' ? 'btn-primary' : 'btn-outline-primary']" @click="store.toggleTheme('light')">
        <icon-sun class="w-5 h-5 shrink-0 ltr:mr-2 rtl:ml-2" />
        Light
       </button>
       <button type="button" class="btn" :class="[store.theme === 'dark' ? 'btn-primary' : 'btn-outline-primary']" @click="store.toggleTheme('dark')">
        <icon-moon class="w-5 h-5 shrink-0 ltr:mr-2 rtl:ml-2" />
        Dark
       </button>
       <button type="button" class="btn" :class="[store.theme === 'system' ? 'btn-primary' : 'btn-outline-primary']" @click="store.toggleTheme('system')">
     ...
     <div class="border border-dashed border-[#e0e6ed] dark:border-[#1b2e4b] rounded-md mb-3 p-3">
      ...
      <div class="grid grid-cols-3 gap-2 mt-3">
       <button type="button" class="btn" :class="[store.menu === 'horizontal' ? 'btn-primary' : 'btn-outline-primary']" @click="store.toggleMenu('horizontal')">
        Horizontal
       </button>
       <button type="button" class="btn" :class="[store.menu === 'vertical' ? 'btn-primary' : 'btn-outline-primary']" @click="store.toggleMenu('vertical')">
        Vertical
       </button>
       <button
        type="button"
     ...
     <div class="border border-dashed border-[#e0e6ed] dark:border-[#1b2e4b] rounded-md mb-3 p-3">
      ...
      <div class="flex gap-2 mt-3">
       <button type="button" class="btn flex-auto" :class="[store.rtlClass === 'ltr' ? 'btn-primary' : 'btn-outline-primary']" @click="store.toggleRTL('ltr')">
        LTR
       </button>
       <button type="button" class="btn flex-auto" :class="[store.rtlClass === 'rtl' ? 'btn-primary' : 'btn-outline-primary']" @click="store.toggleRTL('rtl')">
        RTL
       </button>
      </div>
     </div>
