        ...
        <li class="nav-item">
         <router-link to="/apps/notes" class="group" @click="toggleMobileMenu">
          <div class="flex items-center">
           ...
           <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ $t('notes') }}</span>
          </div>
         </router-link>
        </li>
        <li class="nav-item">
         <router-link to="/apps/scrumboard" class="group" @click="toggleMobileMenu">
          <div class="flex items-center">
           ...
           <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ $t('scrumboard') }}</span>
          </div>
         </router-link>
        </li>
        <li class="nav-item">
         <router-link to="/apps/contacts" class="group" @click="toggleMobileMenu">
          <div class="flex items-center">
           ...
           <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ $t('contacts') }}</span>
          </div>
         </router-link>
        </li>
        ...
        <li class="menu nav-item">
         ...
         >
          <div class="flex items-center">
           ...
           <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ $t('invoice') }}</span>
          </div>
        ...
        <li class="nav-item">
         <router-link to="/apps/calendar" class="group" @click="toggleMobileMenu">
          <div class="flex items-center">
           ...
           <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ $t('calendar') }}</span>
          </div>
         </router-link>
        </li>
       </ul>
      ...
      <li class="menu nav-item">
       ...
       >
        <div class="flex items-center">
         ...
         <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ $t('components') }}</span>
        </div>
      ...
      <li class="menu nav-item">
       <router-link to="/font-icons" class="nav-link group" @click="toggleMobileMenu">
        <div class="flex items-center">
         ...
         <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ $t('font_icons') }}</span>
        </div>
       </router-link>
      </li>
      ...
      <li class="menu nav-item">
       <router-link to="/dragndrop" class="nav-link group" @click="toggleMobileMenu">
        <div class="flex items-center">
         ...
         <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ $t('drag_and_drop') }}</span>
        </div>
       </router-link>
      </li>
      ...
      <li class="menu nav-item">
       ...
       >
        <div class="flex items-center">
         ...
         <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ $t('datatables') }}</span>
        </div>
