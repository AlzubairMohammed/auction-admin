        ...
        <form @submit.prevent="confirm">
         <div class="mb-5">
          <div>
           ...
           <p class="text-gray-600 dark:text-gray-400">معدل الاهلاك : {{ result.depreciation_rate }}</p>
           <p class="text-gray-600 dark:text-gray-400">قيمة الاهلاك : {{ result.depreciation_value }}</p>
          </div>
         </div>
