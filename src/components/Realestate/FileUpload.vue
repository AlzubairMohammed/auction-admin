...
<template>
 <AddingBar :clicked-function="" title="اضافة حقل لتحميل مزيد من الملفات" class="mt-3" />
 <div
 ...
 >
  ...
  <FlexibleFileUpload @file-selected="" :index="index" class="m-3" error-message="الحقل مطلوب" required />
 </div>
</template>
