    ...
    <div class="flex justify-between flex-wrap px-4">
     ...
     <div class="lg:w-1/2 w-full lg:max-w-fit">
      <div class="flex items-center">
       ...
       <input id="number" type="text" name="inv-num" class="form-input lg:w-[250px] w-2/3" placeholder="#8801" v-model="params.invoiceNo" />
      </div>
      <div class="flex items-center mt-4">
       <label for="invoiceLabel" class="flex-1 ltr:mr-2 rtl:ml-2 mb-0">Invoice Label</label>
       <input id="invoiceLabel" type="text" name="inv-label" class="form-input lg:w-[250px] w-2/3" placeholder="Enter Invoice Label" v-model="params.title" />
      </div>
      <div class="flex items-center mt-4">
     ...
     <div class="flex justify-between lg:flex-row flex-col">
      <div class="lg:w-1/2 w-full ltr:lg:mr-6 rtl:lg:ml-6 mb-6">
       ...
       <div class="mt-4 flex items-center">
        ...
        <input id="reciever-name" type="text" name="reciever-name" class="form-input flex-1" v-model="params.to.name" placeholder="Enter Name" />
       </div>
       <div class="mt-4 flex items-center">
        <label for="reciever-email" class="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">Email</label>
        <input id="reciever-email" type="email" name="reciever-email" class="form-input flex-1" v-model="params.to.email" placeholder="Enter Email" />
       </div>
       <div class="mt-4 flex items-center">
        <label for="reciever-address" class="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">Address</label>
        <input id="reciever-address" type="text" name="reciever-address" class="form-input flex-1" v-model="params.to.address" placeholder="Enter Address" />
       </div>
       <div class="mt-4 flex items-center">
        <label for="reciever-number" class="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">Phone Number</label>
        <input id="reciever-number" type="text" name="reciever-number" class="form-input flex-1" v-model="params.to.phone" placeholder="Enter Phone number" />
       </div>
      </div>
      <div class="lg:w-1/2 w-full">
       ...
       <div class="flex items-center mt-4">
        ...
        <input id="acno" type="text" name="acno" class="form-input flex-1" v-model="params.bankInfo.no" placeholder="Enter Account Number" />
       </div>
       <div class="flex items-center mt-4">
        <label for="bank-name" class="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">Bank Name</label>
        <input id="bank-name" type="text" name="bank-name" class="form-input flex-1" v-model="params.bankInfo.name" placeholder="Enter Bank Name" />
       </div>
       <div class="flex items-center mt-4">
        <label for="swift-code" class="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">SWIFT Number</label>
        <input id="swift-code" type="text" name="swift-code" class="form-input flex-1" v-model="params.bankInfo.swiftCode" placeholder="Enter SWIFT Number" />
       </div>
       <div class="flex items-center mt-4">
        <label for="iban-code" class="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">IBAN Number</label>
        <input id="iban-code" type="text" name="iban-code" class="form-input flex-1" v-model="params.bankInfo.ibanNo" placeholder="Enter IBAN Number" />
       </div>
       <div class="flex items-center mt-4">
    ...
    <div class="panel mb-5">
     ...
     <div class="mt-4">
      <div>
       ...
       <input id="shipping-charge" type="number" name="shipping-charge" class="form-input" placeholder="Shipping Charge" v-model="shippingCharge" />
      </div>
     </div>
     <div class="mt-4">
