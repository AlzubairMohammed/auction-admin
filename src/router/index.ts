...
const routes: RouteRecordRaw[] = [
  ...
  //font-icons
  {
    ...
    name: "font-icons",
    component: () =>
      import(/* webpackChunkName: "font-icons" */ "../views/font-icons.vue"),
  },
...

  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "list-page" */ "../views/auctions/list-page.vue"
      ),
    meta: { layout: "app" },
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "add-page */ "../views/auctions/add-page.vue"
      ),
    meta: { layout: "app" },
  },
  {
